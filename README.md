...
Just open `index.html` in a browser, or visit [board.arnofaure.com](https://board.arnofaure.com).

## How to use it

1. Add a **column** at the end of the board, then add **cards** inside it.
2. **Drag** a card between columns, or drag a column's header to reorder columns.
3. Click a card to set its **due date**, add a **checklist**, upload a **cover image**, move it to another column, or pick a color.
4. Switch to the **Timeline** view (top bar) to see every card sorted by due date.
5. Switch to **Today** for a daily to-do list, or **Random Ideas** to jot things down and turn them into boards later.
6. Export your data regularly from the logo menu — it's your only backup, since everything lives in this browser only.
